 ...
 */
function robcommerce_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['robcommerce_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('robcommerce sample setting'),
  '#default_value' => theme_get_setting('robcommerce_example'),
